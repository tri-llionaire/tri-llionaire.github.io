#!/usr/bin/python
# -*- coding: utf-8 -*-
#add double pawn move, en passant, castling, promotion
import sys, re
...
if __name__ == '__main__':
  ...
  argparser.add_argument('--user1', help = '1st username', default = '')
  argparser.add_argument('--user2', help = '2nd username', default = '')
  ...
  while True:
    ...
    if move_legal:
      ...
      print('%s, PLEASE TRY AGAIN' % (message))
